    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <a href="new.php" class="btn btn-danger">Nuevo Usuario</a>
          <?php 
          if(isset($_GET['estacionamiento']) && $_GET['estacionamiento']=='false'){
          	echo ' <a href="user.php" class="btn btn-success">Ver Usuarios con estacionamiento</a>';
          }else{
          	echo ' <a href="user.php?estacionamiento=false" class="btn btn-success">Ver Usuarios sin estacionamiento</a>';
          }
